...
st.set_page_config(page_title="SPX Diagonal Engine v6.9.6", layout="wide")
...
with c4:
    ...
    fig.update_layout(height=120, margin=dict(t=5, b=5, l=5, r=5), paper_bgcolor="#1e293b", font_color="#e2e8f0")
    st.plotly_chart(fig, use_container_width=True)

with c5:
    st.markdown(f'<div class="metric-card"><p style="font-size:11px; color:#94a3b8; margin:0;">SPX • ES Futures</p><p class="big-num">SPX: {spx_price:,.0f}<br>ES: {es_price:,.0f}</p><p style="font-size:10px; color:#94a3b8; margin:0;">Live {now_str}</p></div>', unsafe_allow_html=True)
...
st.markdown("<p style='text-align:center;color:#475569;margin-top:100px;font-size:14px;'>SPX Debit Put Diagonal Engine v6.9.5 — Live 24/7 • 2025</p>", unsafe_allow_html=True)
