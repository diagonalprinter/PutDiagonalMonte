...
st.set_page_config(page_title="SPX Diagonal Engine v6.9.22", layout="wide")
...
# === FIXED REGIME (STREAMLINED BUCKETS) ===
def get_regime(r):
...
st.caption("SPX Diagonal Engine v6.9.22 — TROPHY • Live Forward Curve • Nuclear Alert • 100 % WORKING • Dec 2025")
